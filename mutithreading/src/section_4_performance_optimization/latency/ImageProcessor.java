package section_4_performance_optimization.latency;
...
public class ImageProcessor {
    private static final String SOURCE_FILE = "./resources/latency/many-flowers.jpg";
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.printf("Processing time = %s", duration);
    }
    ...
    public static void recolorImage(BufferedImage originalImage, BufferedImage resultImage, int leftCorner,
        ...
        for (int x = leftCorner; x < leftCorner + width && x < originalImage.getHeight(); x++) {
    ...
    public static void recolorPixel(BufferedImage orignalImage, BufferedImage resultImage, int x, int y) {
        int rgb = orignalImage.getRGB(x, y);
        ...
        int newRGB = creatRGBFromColors(newRed, newGreen, newBlue);
        setRGB(resultImage, x, y, newRGB);
    }

    public static void setRGB(BufferedImage targetImage, int x, int y, int rgb) {
    ...
    public static int creatRGBFromColors(int red, int green, int blue) {
        int rgb = 0;
